...
_RENDER_PROFILE_OUTPUT_RECOMMENDATIONS: dict[str, str] = {
    ...
    "community_shaders": (
        "Files: diffuse + normal + _p. Add _cm (or _c naming) for Community Shaders packed-material/PBR workflows; "
    ...
    "enb": (
        ...
        "Use complex _rmaos (or _m legacy naming) only for ENB workflows that explicitly expect it; add _g only for emissive assets."
    ),
}
...
_SKYRIM_SE_SUFFIX_INFO: dict[str, tuple[str, str, str]] = {
    ...
    "_rmaos": (
        "environment_mask",
        "Complex Environment Mask (_rmaos)",
        "ENB/community complex-material naming variant for reflection/roughness/metalness/occlusion-style masking. "
        "Usually authored for Texture Slot 5 workflows that rely on complex channel packing.",
    ),
    "_s": (
        "subsurface",
    ...
    "_c": (
        "complex_material_cm",
        "Complex Material Packed (_c naming)",
        "Community Shaders/complex-material naming variant equivalent to packed complex material workflows. "
        "Use when a mod expects _c.dds naming instead of _cm.dds.",
    ),
}
